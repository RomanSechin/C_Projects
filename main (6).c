...
int main()
{
    ...
    fprintf(stdout, "t\t\tU(t)\t\tU4(t)\t\tU20(t)\t\tU50(t)\t\n");
...
//        Print(stdout, t);
//        Print(stdout, fun(t));
//        Print(stdout, U_m(4, t));
//        Print(stdout, U_m(20, t));
//        Print(stdout, U_m(50, t));
//        fprintf(stdout, "\n");
    }
...
// ---------------------------------------------------------
double u_t(double t, double T, double a, double b)
{
    while(t < -T/2) t += T;
    while(t > T/2) t -= T;
